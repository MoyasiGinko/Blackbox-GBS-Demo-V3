...
const apiClient = axios.create({
  baseURL: 'https://ntvpp5-8000.csb.app/api',
...
export const paymentApi = {
  createPayment: (data: any) => apiClient.post('/payment/payments/create/', data),
}

export const cookieManagementApi = {
  addLoginService: (data: any) => apiClient.post('/cookie_management/login_services/add/', data),
  getCookieData: (id: string) => apiClient.get(`/cookie_management/cookies/${id}/`),
}
